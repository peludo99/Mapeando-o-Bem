        ...
        <div class="esquerda">
            <div class="conteudo-esquerda" style="overflow-y: scroll;">
                ...
                <form class="form" action="../views/usuario.php" method="post">
                    ...
                    <button id="btnalterarimg" style="display: none; border: 1px solid black;height:35px;padding:1px;font-size:15px;border-radius: 5%;width:180px; color:black;margin-top: 2%; background-color:#c0bfbf;" data-bs-toggle="modal" data-bs-target="#addarquivo">Alterar Imagem <i class="fa-solid fa-image fa-bounce"></i></button>
